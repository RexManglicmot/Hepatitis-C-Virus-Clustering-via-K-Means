...
K-means is a type of unsupervised learning in which observations are formed into clusters based on k-clusters. These clusters are based similarities and differences of the entire dataset. 
